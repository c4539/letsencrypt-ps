...
$domain = "w2012.gw18.puxbaumer.eu"
$alias = "w2012.gw18.puxbaumer.eu-01"
$iissitename = "Default Web Site"
$certname = "w2012.gw18.puxbaumer.eu-$(get-date -format yyyy-MM-dd--HH-mm)"
...
$OwnerEmailAddress = "simon@puxbaumer.eu"
